...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules\\monaco-editor\\esm\\vs\\basic-languages\\shell\\shell.js":[function(require,module,exports) {
/*---------------------------------------------------------------------------------------------
...
var language = exports.language = {
    ...
    tokenizer: {
        root: [{ include: '@whitespace' }, [/[a-zA-Z]\w*/, {
            cases: {
                '@keywords': 'keyword',
                '@builtins': 'type.identifier',
                '@default': ''
            }
        }], { include: '@strings' }, { include: '@parameters' }, { include: '@heredoc' }, [/[{}\[\]()]/, '@brackets'], [/-+\w+/, 'attribute.name'], [/@symbols/, 'delimiter'], { include: '@numbers' }, [/[,;]/, 'delimiter']],
        ...
        parameters: [[/\$\d+/, 'variable.predefined'], [/\$\w+/, 'variable'], [/\$[*@#?\-$!0_]/, 'variable'], [/\$['"{(]/, 'variable', '@parameterBody']],
        parameterBody: [[/[#:%*@\-!_]/, 'delimiter'], [/['"{(]/, 'variable', '@pop'], [/./, 'variable']]
    }
};
...
},{}]},{},["..\\..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js","node_modules\\monaco-editor\\esm\\vs\\basic-languages\\shell\\shell.js"], null)
//# sourceMappingURL=/shell.9b41d08c.map