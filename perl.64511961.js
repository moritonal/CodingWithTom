...
var language = exports.language = {
    ...
    // Perl syntax
    keywords: ['__DATA__', 'else', 'lock', 'qw', '__END__', 'elsif', 'lt', 'qx', '__FILE__', 'eq', 'm', 's', '__LINE__', 'exp', 'ne', 'sub', '__PACKAGE__', 'for', 'no', 'tr', 'and', 'foreach', 'or', 'unless', 'cmp', 'ge', 'package', 'until', 'continue', 'gt', 'q', 'while', 'CORE', 'if', 'qq', 'xor', 'do', 'le', 'qr', 'y', '__DIE__', '__WARN__'],
    // Perl functions
    ...
    tokenizer: {
        root: [{ include: '@whitespace' }, [/[a-zA-Z\-_][\w\-_]+/, {
            cases: {
                '@keywords': 'keyword',
        ...
        }], { include: '@strings' }, { include: '@dblStrings' },
        // Perl Doc
        { include: '@perldoc' },
        // Here Doc
        { include: '@heredoc' }, [/[{}\[\]()]/, '@brackets'],
        // RegExp
        [/[goseximacplud]*[\/](?:(?:\[(?:\\]|[^\]])+\])|(?:\\\/|[^\]\/]))*[\/]\w*\s*(?=[).,;]|$)/, 'regexp'], [/@symbols/, 'operators'], { include: '@numbers' }, [/[,;]/, 'delimiter']],
        ...
        dblStringBody: [[/"/, 'string', '@popall'], [/@escapes/, 'string.escape'], [/\\./, 'string.escape.invalid'], { include: '@variables' }, [/./, 'string']],
        heredoc: [[/<<\s*['"`]?([\w\-]+)['"`]?/, { token: 'string.heredoc.delimiter', next: '@heredocBody.$1' }]],
        heredocBody: [[/^([\w\-]+)$/, {
            cases: {
...
},{}]},{},["..\\..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js","node_modules\\monaco-editor\\esm\\vs\\basic-languages\\perl\\perl.js"], null)
//# sourceMappingURL=/perl.64511961.map